...
export const RightAnalysisPanel: React.FC<RightAnalysisPanelProps> = ({
  ...
  return (
    <div
      ...
      className="relative z-30 flex flex-col h-full w-80 lg:w-[340px] max-w-[85vw] shrink-0 bg-[#101010] border-l border-[#262626] shadow-xl overflow-y-auto custom-scrollbar select-none text-[#F5F5F5]"
    >
